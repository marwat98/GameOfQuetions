...
public class Question8 extends BasicQuestion implements ActionListener {
    //Dodanie wylosowaych liczb do tablicy
    public Set<Integer> usedNumbers = new HashSet<>();
    JLabel label8 = new JLabel();
    Question8() {
        //Dodawanie tekstu pytania
        label8.setText("8. Który związek najczęściej nazywany jest białkiem młodości?");
        answerA.setText("A. platoniczny");
        answerB.setText("B. poligamiczny");
        answerC.setText("C. keratyna");
        answerD.setText("D. kolagen");

        // Ustawienie tekstu
        label8.setBounds(50, -150, 600, 400);
